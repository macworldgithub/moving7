...
export default function SetupForm() {
    ...
    return (
        <form
            className="bg-white rounded shadow-xl px-4 py-4"
            onSubmit={handleSubmit}
        >
            <h1 className="text-xl font-[500] py-4">Add Payment Mehods</h1>
            <hr className="pb-4 h-2" />
            <PaymentElement />
            <button
                type="submit"
                className="text-black bg-primary rounded px-4 py-2 my-2"
            >
                Submit
            </button>
