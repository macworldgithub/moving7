    ...
    <div className="w-11/12 mx-auto text-center items-center gap-[3%] gap-y-2 pt-[1rem] lg:flex md:flex md:justify-between">
      ...
      <div className="relative inline-block mt-4 sm:right-[24px]">
        ...
        <div>
          <img
            src={CarBg}
            className="absolute md:w-[170px] md:h-[16rem] md:mt-[15px] sm:right-[-47px] md:right-[-56px] lg:right-[-65] lg:h-[380px] lg:mt-12 lg:w-[55%] xl:mt-24  hidden md:block"
            alt=""
          />
        </div>
        ...
        <div className="  ">
          <img
            className="absolute top-[-15px] ml-4 z-[-1]"
            src={BgRing}
            alt=""
          />
        </div>
