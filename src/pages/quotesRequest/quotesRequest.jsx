        ...
        <div className='flex flex-col md:flex-row mt-8 lg:mt-10 gap-4 px-4 relative'>
            <div className='shadow-sm rounded-b-none shadow-gray-400 sm:w-[80%] lg:w-[63%] flex lg:ml-32 py-4 px-8 sm:h-48 md:h-48 lg:h-28'>
                <div className='w-full'>
                    ...
                    <div className='lg:mt-[18px] w-[91%] sm:w-[44%] sm:mt-4 mt-4 -ml-8 lg:-ml-8 lg:w-[59.4%] xl:w-[61.4%] rounded-b-md overflow-x-scroll absolute'>
                        ...
                        {Projects.length > 0 ? (
                            <div className='flex justify-between py-4 px-4 h-52 bg-[#EFF2F3]'>
