...
import Claim from "./RequestClaim";
...
export default function QuotesRequest() {
  ...
  console.log(partnerQuotesData);

  const temp = prJunction?.filter(
    (elem) => elem?.quoteId === quotationData?._id,
  );
  let status = temp?.length > 0 ? temp[0]?.status : "";
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center gap-2 xl:gap-10 ">
              ...
              <div className="flex">
                <input
                  ...
                  className="border rounded-r-none border-gray-300 px-6 w-28 outline-none rounded-md"
                />
                <button className=" bg-[#C1E1EE] text-black py-2 px-6 text-md rounded-sm rounded-l-none">
                  Search
                </button>
              </div>
            </div>
            <table className="lg:mt-[12px] w-full mt-4 sm:mt-4 mt-5 -ml-8 lg:-ml-8 rounded-b-md absolute">
              ...
              <tbody className="bg-gray-100">
                {partnerQuotesData?.length > 0 ? (
                  partnerQuotesData?.map((quote, index) => {
                    const status = prJunction.filter(
                      (elem) => elem.quoteId === quote._id,
                    )[0].status;
                    ...
                    return (
                      ...
                      >
                        <td className="text-para text-center py-2">{quote?.name}</td>
                        <td className="text-para text-center">{quote?.email}</td>
                        <td className="text-para text-center py-2">
                          {status ? status : "Not Paid"}
                        </td>
                        <td className="text-para text-center">
                          {new Date(quote?.requestTime)?.toLocaleString()}
                        </td>
                      </tr>
                    );
                  })
                  ...
                  <tr className="bg-[#EFF2F3]">
                    ...
                    <td className="py-16 w-80 px-4 text-center text-gray-400">
                      No quote requests received yet. We will email you once we
              ...
              <tfoot>
                <tr bg-gray-100>
                  ...
                  <td className="p-2 bg-gray-100 fs-5 text-dark text-para font-primary text-center">
          ...
          {/*
                                <div className='px-4 shadow-lg shadow-gray-300 rounded-lg mt-4'>
                                    ...
                                    <p className='p-1 text-gray-400'>Use our fair reclaims services for
                                        incorrect telephone numbers. <span className="text-sub-head" className='text-[#fffff]'>Terms & Conditions</span></p>
        ...
        <MyModal>
          <div className="lg:w-[50%] min-h-[70%] max-h-[70%]  overflow-y-scroll pb-5 bg-primary rounded-xl p-2 shadow-blue-300 shadow-md flex flex-col  ">
            ...
            <div className=" gap-2 w-full h-full">
              <div className="w-full justify-between flex px-10">
                <h1 className=" text-3xl text-[#fffff] fontbold bold">
                  Details
                </h1>
                <Claim quotationData={quotationData} status={status} />
              </div>
              <div className="flex mx-10 my-2 justify-between flex-wrap">
                <div className="flex w-64 border-black  me-5 flex-col items-start border-b-2 justify-start">
                  <p className="text-[#fffff]">Move From</p>
                ...
                <div className="flex w-64 flex-col items-start  border-black justify-start border-b-2 ">
                  <p className="text-[#fffff]">Move To</p>
              ...
              <div className="flex my-2 mx-10 justify-between flex-wrap">
                ...
                <div className="flex w-64 flex-col items-start  border-black justify-start border-b-2 ">
                  <p className="text-[#fffff]">Bedrooms</p>
              ...
              {quotationData?.currPropertyType === "appartment" ? (
                <div className="flex my-2 mx-10 justify-between flex-wrap">
                  <div className="flex w-64  me-5 flex-col items-start border-black border-b-2 justify-start">
                    <p className="text-[#fffff]">No of Floors</p>
              ...
              <div className="flex mx-10 my-2 justify-between flex-wrap">
                <div className="flex w-64  me-5 flex-col items-start  border-black border-b-2 justify-start">
                  <p className="text-[#fffff]">Scope of Work</p>
                ...
                <div className="flex w-64 flex-col items-start  border-black justify-start border-b-2 ">
                  <p className="text-[#fffff]">Moving Type</p>
              ...
              <h1 className="text-2xl my-4 text-[#fffff] mx-10">Date</h1>

              <div className="flex mx-10 my-2 justify-between flex-wrap">
                <div className="flex w-64  me-5 flex-col items-start border-black border-b-2 justify-start">
                  <p className="text-[#fffff]">Moving Date Preference</p>
              ...
              <div className="flex mx-10 my-2 justify-between flex-wrap">
                <div className="flex w-64  me-5 flex-col items-start border-black border-b-2 justify-start">
                  <p className="text-[#fffff]">
                    {quotationData?.movingDatePref === "flexible"
                      ? "Start Date"
                      : "Date"}
                  </p>
              ...
              <div className="flex my-2 mx-10 justify-between flex-wrap">
                ...
                <div className="flex w-64 flex-col items-start justify-start border-black border-b-2 ">
                  <p className="text-[#fffff]">Email</p>

                  <p className="text-gray-500">{quotationData?.email}</p>
                </div>
              </div>

              <div className="flex my-2 mx-10 justify-between flex-wrap">
                <div className="flex w-64  me-5 flex-col items-start border-black border-b-2 justify-start">
                  <p className="text-[#fffff]">Contact number</p>
                ...
                <div className="flex w-64 flex-col items-start justify-start border-black border-b-2 ">
                  <p className="text-[#fffff]">Flat name / Office / Villa</p>

                  <p className="text-gray-500">{quotationData?.building}</p>
                </div>
              </div>
