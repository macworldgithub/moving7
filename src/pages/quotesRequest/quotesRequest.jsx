    ...
    return (
        <>
            <div className='flex flex-col md:flex-row mt-8 lg:mt-10 gap-4 px-4'>
                <div className='shadow-sm rounded-b-none shadow-gray-400 sm:w-[80%] lg:w-[63%] flex lg:ml-28 py-6 px-8 sm:h-48 md:h-48 lg:h-28 relative'>
                    <div className='w-full'>
                        ...
                        <div className='lg:mt-[12px] w-full mt-4 sm:mt-4 md:-mt-1 -ml-8 lg:-ml-8 rounded-b-md absolute'>
