...
export default function Documents() {
  ...
  const submit = async () => {
    ...
    for (let key in proofs) {
      ...
      if (proofs[key].url && proofs[key].expirationDate) {
        let firebaseUrl = await uploadImageAndGetURL(
          ProofsData[key].firebasePath,
          proofs[key].url,
        );
        temp[key] = {
        ...
        <div className="flex flex-col w-11/12 md:w-[60%] mt-10 g-red-400 ">
          ...
          <div className="ml-0  rounded-md shadow-xl border-2">
            <div className="px-8 py-4 flex justify-between items-center border-b-2">
              ...
              <button
                onClick={submit}
                className={`${isDisabled() ? "bg-gray-500 text-white" : "bg-primary text-black"}  px-6 py-1 rounded-sm `}
              >
                Save
              </button>
            </div>
            <div className="flex flex-col p-4">
              <div className="flex justify-between gap-2 lg:gap-2 p-4 order-b-2 items-center">
                ...
                <div className="flex items-center gap-2">
                  {proofs?.VATcert?.url ? (
                    <p className="text-primary">{proofs?.VATcert?.url?.name}</p>
                  ) : (
                    <a
                      href={ProofsData?.VATcert?.url}
                      target="_blank"
                  ...
                  <input
                    ...
                    onClick={() =>
                      setIsEditable({ ...isEditable, VATcert: true })
                    }
                    onChange={(e) => {
                      const file = e.target.files[0];
                      setProofs({
                        ...proofs,
                        VATcert: { ...proofs.VATcert, url: file },
                      });
                      console.log(file);
                    }}
                    type={"file"}
              ...
              <div className="flex flex-col justify-between gap-2 lg:gap-4 p-4 border-b-2 items-center">
                <div className="flex items-center justify-between w-full">
                  ...
                  {isEditable?.VATcert ? (
                    ...
                    <p>
                      {new Date(
                        ProofsData?.VATcert?.expirationDate,
                      ).toDateString()}
                    </p>
                  )}
                </div>
              ...
              <div className="flex justify-between gap-2 lg:gap-2 p-4 order-b-2 items-center">
                <h2 className="font-medium text-black">
                  National Id of Authorize Person
                </h2>
                <div className="flex items-center gap-2">
                  {proofs?.emiratesId?.url ? (
                    ...
                    <a
                      href={ProofsData?.emiratesId?.url}
                      target="_blank"
                      className="z-10 text-black"
                    >
                      Show
                  ...
                  <input
                    className="absolute opacity-0 z-0"
                    onClick={() =>
                      setIsEditable({ ...isEditable, emiratesId: true })
                    }
                    onChange={(e) => {
                      const file = e.target.files[0];
                      setProofs({
                        ...proofs,
                        emiratesId: { ...proofs.emiratesId, url: file },
                      });
                      console.log(file);
                    }}
                    type={"file"}
              ...
              <div className="flex flex-col justify-between gap-2 lg:gap-4 p-4 border-b-2 items-center">
                <div className="flex items-center justify-between w-full">
                  ...
                  {isEditable?.emiratesId ? (
                    ...
                    <p>
                      {new Date(
                        ProofsData?.emiratesId?.expirationDate,
                      ).toDateString()}
                    </p>
                  )}
                </div>
              ...
              <div className="flex justify-between gap-2 lg:gap-2 p-4 order-b-2 items-center">
                ...
                <div className="flex items-center gap-2">
                  {proofs?.insuranceCert?.url ? (
                    ...
                    <a
                      href={ProofsData?.insuranceCert?.url}
                      target="_blank"
                      className="z-10 text-black"
                    >
                      Show
                  ...
                  <input
                    className="absolute opacity-0 z-0"
                    onClick={() =>
                      setIsEditable({ ...isEditable, insuranceCert: true })
                    }
                    onChange={(e) => {
                      const file = e.target.files[0];
                      setProofs({
                        ...proofs,
                        insuranceCert: { ...proofs.insuranceCert, url: file },
                      });
                      console.log(file);
                    }}
                    type={"file"}
              ...
              <div className="flex flex-col justify-between gap-2 lg:gap-4 p-4 border-b-2 items-center">
                <div className="flex items-center justify-between w-full">
                  <h2 className="text-sm text-black">Expiry Date</h2>
                  {isEditable?.insuranceCert ? (
                    <DatePicker
                      onChange={(_, dateStr) => {
                        setProofs({
                          ...proofs,
                          insuranceCert: {
                            ...proofs.insuranceCert,
                            expirationDate: dateStr,
                          },
                        });
                      }}
                    ...
                    <p>
                      {new Date(
                        ProofsData?.insuranceCert?.expirationDate,
                      ).toDateString()}
                    </p>
                  )}
                </div>
              ...
              <div className="flex justify-between gap-2 lg:gap-2 p-4 order-b-2 items-center">
                ...
                <div className="flex items-center gap-2">
                  {proofs?.license?.url ? (
                    <p className="text-primary">{proofs?.license?.url?.name}</p>
                  ) : (
                    <a
                      href={ProofsData?.license?.url}
                      target="_blank"
                      className="z-10 text-black"
                    >
                      Show
                  ...
                  <input
                    className="absolute opacity-0 z-0"
                    onClick={() =>
                      setIsEditable({ ...isEditable, license: true })
                    }
                    onChange={(e) => {
                      const file = e.target.files[0];
                      setProofs({
                        ...proofs,
                        license: { ...proofs.license, url: file },
                      });
                      console.log(file);
                    }}
                    type={"file"}
              ...
              <div className="flex flex-col justify-between gap-2 lg:gap-4 p-4 border-b-2 items-center">
                <div className="flex items-center justify-between w-full">
                  ...
                  {isEditable?.license ? (
                    ...
                    <p>
                      {new Date(
                        ProofsData?.license?.expirationDate,
                      ).toDateString()}
                    </p>
                  )}
                </div>
