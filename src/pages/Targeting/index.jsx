                    ...
                    <div className='flex flex-col text-lg'>
                        ...
                        <div className='flex flex-col mt-2 lg:-mt-3 w-full'>
                            ...
                            <div className='flex flex-col lg:flex-row items-center gap-4 lg:gap-28 px-4 py-10'>
                                <p className='text-gray-400'>Radius 20 miles from Seattle, WA, USA</p>
                                <button className='bg-primary px-6 py-2 text-white rounded-md'>Residential</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div className='w-11/12 md:w-7/12 lg:w-1/5 mt-8 rounded-md shadow-xl'>
                    <div className='px-4 py-4 shadow-lg shadow-gray-300 rounded-lg mt-4'>
