            ...
            <div className="mb-40 mx-10 mt-4">
                ...
                <div className="mt-8">
                    <div className="flex border-b-2 pb-1">
                        ...
                        <p className="px-3 mx-1 cursor-pointer">Reviews</p>
                            ...
                            >
                                {partnerData?.images?.length ? (
                                    <>
                                        <img
                                            className="w-[44rem]"
                                            src={`${partnerData?.images[0]?.url ?? AddImage}`}
                                        />
                                        <div>
                                            <img
                                                className="h-1/2"
                ...
                <MyModal>
                    <div className="bg-white relative w-4/5 rounded-lg px-5 pb-10 py-5  h-4/5">
                        ...
                        <img
                            ...
                            src={partnerData?.images[currImage]?.url ?? AddImage}
                        />
                        <div>
                            <AiOutlineLeft
                                onClick={() => {
                        ...
                        <div className="">
                            <AiOutlineRight
                                onClick={() =>
                                    setCurrImage((currImage + 1) % partnerData?.images?.length)
                                }
                                style={{
                                    fontSize: "40px",
                                }}
