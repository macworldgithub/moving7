        ...
        <div className="flex items-center justify-center flex-col mt-40 md:mt-0">
          ...
          <div className="flex">
            ...
            <input
              ...
              className=" md:h-12 md:w-80 w-full pl-3 bg-[#C1E1EE] placeholder:text-black outline-none"
            />
          </div>
          <div className="flex mt-4">
            <div className="bg-[#C1E1EE] p-2">
              <img
                src={Lock}
                alt=""
                className="md:w-6 flex items-center justify-between"
              />
            </div>
            <input
              type="password"
              ...
              className=" md:h-12 w-full md:w-80 pl-3 bg-[#C1E1EE] shadow-xl placeholder:text-black outline-none"
            />
          </div>
          ...
          <div>
            <Link to={"/partnerSignUp"}>
              <h2 className="italic text-black font-medium cursor-pointer mt-3 mb-3">
                Create account
              </h2>
            </Link>
          </div>
