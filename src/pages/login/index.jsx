...
export default function Login() {
    return (
        <>
            ...
            <div className=' w-4/5 xl:w-1/3 mt-24 bg-[#EDEDED] mx-auto relative rounded-3xl'>
            ...
            <div className='flex items-center justify-center bg-slate-300 w-44 md:w-96 mx-auto py-4 rounded-b-3xl bg-gradient-to-b from-[#13C265] to-[#BEDBBE] text-white md:text-2xl'>
                <button>Login</button>
            </div>
        </>
    )
