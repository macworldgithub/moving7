...
const PartnerForm = () => {
    ...
    return (
        <div className='flex justify-center items-center mt-40'>
            <div className='absolute w-72 sm:w-80 md:w-72 lg:w-80 md:mt-[-460px] md:ml-[393px] lg:right-20 p-6 mt-20 lg:mt-6 bg-white lg:top-64 border border-solid border-[#13C265] mx-auto shadow-lg shadow-bottom-red '>
                <div>
