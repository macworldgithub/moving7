    ...
    <div className="flex justify-center items-center mt-40">
      <div className='absolute w-72 sm:w-80 md:w-72 lg:w-80 md:mt-[-460px] md:ml-[393px] lg:right-20 p-6 mt-20 lg:mt-6 bg-white lg:top-64 border border-solid border-[#13C265] mx-auto shadow-lg shadow-bottom mr-4" style="background-color: #13C265; width: 100px; height: 100px;'>
        <div>
          ...
          <p className="lg:text-sm font-light bottom-6">
        ...
        >
          <>
            <Input
              ...
              className="mb-1 p-2 placeholder-black font-medium"
            />
            <Input
          ...
          <Button
            className="w-full bg-[#13C265] text-white text-md font-medium"
            htmlType="submit"
          >
            Start your free trial
          </Button>
          <button className="flex justify-center mx-auto items-center underline text-blue-400">
            sign in
          </button>
        </Form>
      </div>
      <div className="custom-shadow w-40"></div>
    </div>
  );
};
