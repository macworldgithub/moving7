                        ...
                        <div className=" bg-white rounded-md border-[#13C26580] border-[1.5px]">
                            <div className="flex w-[255px] md:w-[516px] px-2 py-1">
                                <input
                                    ...
                                    type="radio" name="areaPreference" />
                                ...
                                <div className="flex flex-wrap gap-2 md:gap-4 mt-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            value={data.radius}
                                            onChange={(e) => handleDataChange("radius", e.target.value)}
                                        />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div>
                        ...
                        <div className="mt-2 mb-4">
                            ...
                            <input
                                type="number"
                                placeholder="Select"
                                onChange={(e) => handleDataChange("noOfEmployees", e.target.value)}
                        ...
                        <div>
                            ...
                            <input
                                type="text"
                                onChange={(e) => handleDataChange("telephone", e.target.value)}
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <input
                                    onChange={(e) => handleDataChange("salutation", e.target.value)}
