...
export default function Rating() {
  return (
    <div className="flex items-center justify-around flex-wrap gap-8 sm:p-6 mt-8">
      <div>
        <img src={ResultsImg} alt="" className=" w-32 lg:w-full" />
      ...
      <div>
        <img src={ThousandImg} alt="" className=" w-32 lg:w-full" />
        <div className="flex items-center gap-1">
      ...
      <div className="w-60 sm:w-auto">
        <img src={HundredImg} alt="" className="h-10 lg:h-full lg:w-[120px]"/>
        <div className="flex items-center gap-1">
